...
reduced_matrix = pca.fit(pca_data)
...
for G in graphs:
    ...
    pyg_graph.train_mask = k_sets_net[0][1][0]
    pyg_graph.valid_mask = k_sets_net[0][1][1]
    pyg_graph.test_mask = k_sets_net[0][1][2]
...
import pickle
with open('test_cancer_full_expression_pc50_{}.pkl'.format(network_name), 'wb') as f:
