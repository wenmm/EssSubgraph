...
class ProcessDataset(object):
    ...
    def partitionDataset(self):
        ...
        """
        if self.embedF == 1:
            fn1 = os.path.join(self.data_dir, 'ess_string_Feature.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_string_Feature.pickle')
        elif self.embedF == 0:
            fn1 = os.path.join(self.data_dir, 'ess_seqFeature.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_seqFeature.pickle')
        else:
            fn1 = os.path.join(self.data_dir, 'ess_seq_net_Feature.pickle')
            fn2 = os.path.join(self.data_dir, 'ness_seq_net_Feature.pickle')
