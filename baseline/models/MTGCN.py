...
class MTGCNNet(torch.nn.Module):
    def __init__(self,args):
        ...
        self.args = args
        self.conv1 = ChebConv(50, 128, K=2, normalization="sym")
        self.conv2 = ChebConv(128, 128, K=2, normalization="sym")
        self.conv3 = ChebConv(128, 1, K=2, normalization="sym")

        self.lin1 = Linear(50, 128)
        self.lin2 = Linear(50, 128)
