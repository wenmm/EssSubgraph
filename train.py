...
def main():
    ...
    dataset = load_obj('/home/hwen6/project/essential_gene_prediction/cancer_perturbations_10_5CV/cancer_full_expression_pc50_STRING_subgraph_{}_perturbation.pkl'.format(args.networks))
    ...
    for n in range(len(dataset)):
        ...
        for i in range(10):
            for cv_run in range(5):
                model_dir = prepare_folder("dep_pc50_{}_{}_{}".format(args.networks, i, cv_run), args.model)
